  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: "/human",
          name: "human",
          component: () => import("@/view/pages/human/Human.vue"),
          children: [
            {
              path: "employee",
              name: "employee",
              component: () => import("@/view/pages/human/Employee.vue")
            }
          ]
        },
        {
          path: "/purchase",
          name: "purchase",
          component: () => import("@/view/pages/purchase/Purchase.vue"),
          children: [
            {
              path: "order",
              name: "order",
              component: () => import("@/view/pages/purchase/PurchaseOrder.vue")
            },
            {
              path: "request",
              name: "request",
              component: () => import("@/view/pages/purchase/PurchaseRequest.vue")
            },
            {
              path: "description",
              name: "description",
              component: () => import("@/view/pages/purchase/PurchaseDescription.vue")
            },
            {
              path: "approv",
              name: "approv",
              component: () => import("@/view/pages/purchase/PurchaseApproval.vue")
            },
            {
              path: "release",
              name: "release",
              component: () => import("@/view/pages/purchase/PurchaseRelease.vue")
            },
            {
              path: "close/order",
              name: "closeOrder",
              component: () => import("@/view/pages/purchase/PurchaseCloseOrder.vue")
            },
            {
              path: "close/request",
              name: "closeRequest",
              component: () => import("@/view/pages/purchase/PurchaseCloseRequest.vue")
            }
          ]
        },
        {
